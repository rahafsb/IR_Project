...
GOOGLE_ACCOUNT_NAME="rahaf" # without the @post.bgu.ac.il or @gmail.com part
...
gcloud compute instances create instance-1 \
  ...
  --network-interface=address=34.136.108.198,network-tier=PREMIUM,subnet=default \
...
gcloud compute scp LOCAL_PATH_TO/search_frontend.py rahaf@instance-1:/home/rahaf
