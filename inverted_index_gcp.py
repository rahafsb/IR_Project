...
class InvertedIndex:
    ...
    def add_doc(self, doc_id, tokens):
        ...
        self.doc_length[doc_id] = len(tokens)  # adding the document length
    ...
    def write(self, base_dir, name, bucket_name):
    ...
    @staticmethod
    def write_a_posting_list(b_w_pl, base_dir, bucket_name=None, sort=False):
    ...
    def delete_index(base_dir, name):
        index_path = Path(base_dir) / f'{name}.pkl'
